  ...
  return (
    <div className="mx-auto max-w-6xl px-6">
      ...
      <section className="flex min-h-[88vh] flex-col items-center justify-center text-center">
        {/* Badge */}
        <span className="mb-8 inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-4 py-1.5 text-xs tracking-widest text-neutral-400 uppercase">
        ...
        >
          A curated archive
          <br />
          <span className="text-neutral-500">of things worth keeping.</span>
        </h1>

        {/* Supporting text */}
        <p className="mb-10 max-w-xl text-base leading-relaxed text-neutral-400">
          Films, anime, series, books, and other media — organised with intention.
          This is a personal library, not a recommendation engine.
        </p>
        ...
        <div className="flex flex-wrap items-center justify-center gap-3">
          <Button
            asChild
            size="lg"
            className="rounded-full bg-white px-8 text-sm font-medium text-black hover:bg-neutral-200"
          >
